 ...
 * In all other cases the code is identical to the source. The code is not fully debugged.
 * Set manual frequency for Clock 2 and 3 does not work properly.  Consequently I used the 
 * clock builder program to provide the proper register setting for the frequencies that I needed.
 * PLL reset work fine.
