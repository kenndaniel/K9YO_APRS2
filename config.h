...
// Note Operating the SI5351 transmitter on a pooly tuned antenna can shorten its life.  It is best to use the 
...
// APRS packet configuration variables
#define APRS_SID  11
...
#define APRS_DEBUG_FREQ 14445000000ULL // Frequency used if "#define DEBUG" is uncommented above